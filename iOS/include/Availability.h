/*
    ...
    Mac OS X and __IPHONE_VERSION_MAX_ALLOWED = 1xxx for iPhone.  
    ...
    Examples:
        ...
        An enum available on the phone in 2.0 and later, but not available on Mac OS X:
            ...
            #if __IPHONE_VERSION_MIN_REQUIRED >= __IPHONE_2_0
                enum { myEnum = 1 };
            #endif
        Note: this works because __IPHONE_VERSION_MIN_REQUIRED is undefined and  
