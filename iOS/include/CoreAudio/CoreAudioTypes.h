...
enum
{
    kAudioFormatFlagIsFloat                     = (1L << 0),		// 0x1
    kAudioFormatFlagIsBigEndian                 = (1L << 1),		// 0x2
    kAudioFormatFlagIsSignedInteger             = (1L << 2),		// 0x4
    kAudioFormatFlagIsPacked                    = (1L << 3),		// 0x8
    kAudioFormatFlagIsAlignedHigh               = (1L << 4),		// 0x10
    kAudioFormatFlagIsNonInterleaved            = (1L << 5),		// 0x20
    kAudioFormatFlagIsNonMixable                = (1L << 6),		// 0x40
